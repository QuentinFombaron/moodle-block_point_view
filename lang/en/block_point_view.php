...
$string['defaulttextcontent'] = "This plugin gives the possibility to react and to give difficulties levels to activities.<br/><br/>This plugin is developed by <a href='mailto:q.fombaron@outlook.fr?subject=\"Reaction\"%20Moodle%20plugin%20-%20Feedback'>Quentin Fombaron</a>.<br /><br />You can edit or delete this text in the block configuration menu.<br /><br />";
$string['defaulttexteasy'] = "Easy !";
$string['defaulttexthard'] = "So hard...";
$string['disableall'] = 'Disable all in <b>{$a}</b>';
$string['disable_type'] = 'Disable all';
...
$string['howto_pix_text_group'] = "reaction text";
$string['howto_pix_text_group_help'] = "Custom reaction text";
...
/* Types */
$string['assign'] = 'Assigns';
$string['book'] = 'Books';
$string['data'] = 'Databases';
$string['chat'] = 'Chats';
$string['choice'] = 'Choices';
$string['customcert'] = 'Custom Certificates';
$string['folder'] = 'Folders';
$string['forum'] = 'Forums';
$string['glossary'] = 'Glossaries';
$string['groupselect'] = 'Auto Group Selections';
