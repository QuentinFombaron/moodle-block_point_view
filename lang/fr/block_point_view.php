...
$string['enable_type'] = 'Activer tous/toutes les';
...
$string['howto_pix_text_group'] = "le texte des réactions";
$string['howto_pix_text_group_help'] = "Personnaliser le texte des réactions";
...
$string['book'] = 'Livres';
$string['data'] = 'Bases de Données';
$string['chat'] = 'Chats';
$string['choice'] = 'Sondages';
$string['customcert'] = 'Certificats personnalisés';
$string['folder'] = 'Dossiers';
$string['forum'] = 'Forums';
$string['glossary'] = 'Glossaires';
$string['groupselect'] = 'Auto Sélections de Groupe';
$string['hsuforum'] = 'HSU Forums';
$string['hvp'] = 'H5Ps';
$string['imscp'] = 'Paquetage IMS Content';
$string['label'] = 'Étiquettes';
$string['lesson'] = 'Leçons';
$string['lti'] = 'Outils Externes';
$string['page'] = 'Pages';
$string['questionnaire'] = 'Questionnaires';
$string['quiz'] = 'Tests';
$string['resource'] = 'Fichiers';
$string['scorm'] = 'Paquetages SCORM';
$string['survey'] = 'Consultations';
$string['url'] = 'URLs';
$string['vpl'] = 'VPLs';
$string['wiki'] = 'Wikis';
